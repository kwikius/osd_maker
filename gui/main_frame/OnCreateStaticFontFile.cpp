...
void main_frame::OnCreateStaticFontFile(wxCommandEvent & event)
{
   ...
   if (dlg.ShowModal() == wxID_OK){
     ...
     // todo : FileDialog  put all in one file
      std::string src_filename = dirname + "board/fonts.cpp";
      ...
      std::string hdr_filename = dirname + "board/font.hpp";
      std::ofstream out1 (hdr_filename);
      // check ok
      
      out1 << "#ifndef USER_FONT_HPP_INCLUDED\n";
      out1 << "#define USER_FONT_HPP_INCLUDED\n\n";
