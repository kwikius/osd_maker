...
struct panel : wxWindow// wxPanel
{
  ...
  void add_layout(wxString const & name);
  ...
  wxArrayString get_layout_names()const;
  bool Destroy();
private:
   enum class selection_type{ Unknown, Font, FontDir, Bitmap, BitmapDir, Layout,LayoutDir};
   ...
   void on_layout_item_activated(wxTreeEvent & event);
